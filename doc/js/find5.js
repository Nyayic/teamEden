...
var find_window_background = "#e6e6e6"; // the color of the pop-up window
var find_window_border = "#e6e6e6"; // the border color of pop-up window
...
var find_window_height = 116; // height of window
...
function MouseDown(event) 
{
	...
	if (fobj.className.match(/dragme/i)) // Only drag objects that have class="dragme"		
	{
		...
		drag.drag_obj_x = parseInt(drag.drag_obj.offsetLeft, 10); // get current x of element
		drag.drag_obj_y = parseInt(drag.drag_obj.offsetTop, 10); // get current y of element
...
function create_div(dleft, dtop, dwidth, dheight)
{
	...
	+ ';background-color: #2d3e50' //+ find_window_border
	+ ';float: left' 
	+ ';padding-top: 3px'
	+ ';height: 27px' 
...
// This part creates the instructions and the "find" button
	...
	+ '<form onsubmit="return false;"><input type="search" size="33" maxlength="33" id="fwtext"'
